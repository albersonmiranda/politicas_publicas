...
Na @tbl-q5.b, vemos que os coeficientes de `pothuan_mita` são significativos (5% significância) para os modelos 1 e 3, indicando que a participação na Mita aumenta o consumo das famílias. O coeficiente de `pothuan_mita` é maior
...
Na @tbl-q5.c, vemos que os coeficientes de `dpot` são significativos (5% significância) para os modelos 1 e 3, indicando que a distância até Potosí afeta o consumo das famílias. O coeficiente de `dpot` é maior para o modelo 3, indicando que o efeito da distância é maior para distâncias menores.
...
#| results: asis
#| label: tbl-q5.c
#| tbl-cap: "Regressões com polinômio cúbico na distância até Potosí"
